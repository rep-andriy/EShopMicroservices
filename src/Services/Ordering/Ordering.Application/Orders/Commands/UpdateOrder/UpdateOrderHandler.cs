    ...
    : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    public void UpdateOrderWithNewValues(Order order, OrderDto orderDto)
    {
        ...
        var updatedBillingAddress = Address.Of(orderDto.BillingAddress.FirstName, orderDto.BillingAddress.LastName, orderDto.BillingAddress.EmailAddress, orderDto.BillingAddress.Country, orderDto.BillingAddress.AddressLine, orderDto.BillingAddress.State, orderDto.BillingAddress.ZipCode);
